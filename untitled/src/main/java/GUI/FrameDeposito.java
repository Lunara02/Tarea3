...
/**
 * La clase FrameDeposito extiende JFrame y que muestra las monedas de vuelto de una máquina expendedora.
 * Esta clase crea un marco con un fondo personalizado y varios paneles que contienen las representaciones gráficas de las monedas.
...
public class FrameDeposito extends JFrame {
    ...
    /**
     * Constructor para crear un FrameDeposito.
     * @param a El título del marco.
     * @param Dep La imagen de fondo del marco.
     * @param Ref La referencia a la Expendedora que contiene el vuelto a mostrar.
     */
